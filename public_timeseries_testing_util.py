...
class MockApi:
    def __init__(self):
        ...
        '''
        self.input_paths: Sequence[str] = ['optiver-trading-at-the-close/example_test_files/test.csv', 'optiver-trading-at-the-close/example_test_files/sample_submission.csv']
        self.group_id_column: str = 'stock_id'  
